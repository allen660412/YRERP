...
{
    public partial class FrmInvt521 : YR.ERP.Base.Forms.FrmEntryMDBase
    {
        ...
        protected override Boolean WfIniTabDetailInfo()
        {
            ...
            this.TabDetailList[0].ViewTable = "vw_invt521s";
        ...
        protected override bool WfItemCheck(object sender, ItemCheckInfo e)
        {
            ...
            try
            {
                ...
                if (e.Row.Table.Prefix.ToLower() == "vw_invt521s")
                {
                    uGrid = sender as UltraGrid;
                    detailModel = e.Row.ToItem<vw_invt521s>();
