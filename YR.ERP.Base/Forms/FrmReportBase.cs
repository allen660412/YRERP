...
{
    public partial class FrmReportBase : YR.ERP.Base.Forms.FrmBase
    {
        #region Property
        public ReportInfo TabMaster = new ReportInfo();     // 保存報表相關物件    
        ...
        private void FrmReportBase_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Shown += FrmReportBase_Shown;
            }
            catch (Exception ex)
            {
                IniSuccess = false;
        ...
        private void FrmReportBase_Shown(object sender, EventArgs e)
        {
        ...
        //{
        //    StiViewerControl ss = sender as StiViewerControl;
        //    ss.Report.Print(true);
        //    //ss.InvokeClickPrintButton();

        //}

        #region report_Print 按下列印後事件
        ...
        /// <summary>
        /// 按下報表列印後執行事件,通常為寫入列印次數
        /// </summary>
        /// <param name="pStiReport"></param>
        protected virtual void WfAfterPrint(StiReport pStiReport)
        {
        }
        #endregion
