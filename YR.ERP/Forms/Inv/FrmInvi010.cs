...
{
    public partial class FrmInvi010 : YR.ERP.Base.Forms.FrmEntryBase
    {
        ...
        protected override bool WfItemCheck(object sender, ItemCheckInfo e)
        {
            ...
            try
            {
                ...
                if (e.Row.Table.Prefix.ToLower() == "vw_invi010")
                {
