...
{
    public class Glab313BLL : YR.ERP.BLL.MSSQL.GlaBLL
    {
        private UserInfo _loginInfo = null;

        #region Glab313BLL() :　建構子
        public Glab313BLL()
            : base()
        {
        }
        ...
        public Glab313BLL(DbConnection pConnection)
            : base(pConnection)
        {
        ...
        private bool OfPostGbi(gfa_tb pGfaModel, gfb_tb pGfbModel, gba_tb pGbaModel, Result pResult)
        {
            ...
            try
            {
                ...
                {
                    pResult.Key1 = string.Concat(pGfbModel.gfb01, "/", pGfbModel.gfb02);
                    pResult.Message = "更新會科每日餘額檔(gbi_tb)失敗!查無該會科餘額檔!";
                    return false;
                }
                else
                {
