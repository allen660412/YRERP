...
{
    public partial class FrmStpi031 : YR.ERP.Base.Forms.FrmEntryMDBase
    {
        #region Property
        StpBLL BoStp = null;
        #endregion
        ...
        public FrmStpi031(string pSourceForm, YR.ERP.Shared.UserInfo pUserInfo, string pWhere)
        {
            InitializeComponent();
        ...
        protected override Boolean WfIniTabDetailInfo()
        {
            ...
            this.TabDetailList[0].TargetTable = "sdd_tb";
            this.TabDetailList[0].ViewTable = "vw_stpi031s";
            keyParm = new SqlParameter("sdd01", SqlDbType.NVarChar);
            ...
            try
            {
                switch (pTabIndex)
                {
                    case 0:
                        ...
                        ugc = uGrid.DisplayLayout.Bands[0].Columns["sdd06"];//稅別
                        WfSetGridValueList(ugc, BoStp.OfGetTaxTypeKVPList());
                        break;
                }
            }
            catch (Exception ex)
        ...
        protected override void WfSeDetailGridLayout(UltraGrid pUgrid)
        {
            ...
            try
            {
                if (pUgrid.DisplayLayout.Bands[0].Columns.Exists("sdd08"))
                {
                    lugc = pUgrid.DisplayLayout.Bands[0].Columns["sdd08"];
